...
// Import Components
import ActivityLineChart from "@/components/analytics/charts/ActivityLineChart";
import RevenueChart from "@/components/analytics/charts/RevenueChart";
import TopCountries from "@/components/analytics/charts/TopCountries";
import WeeklyVisitorsRadarChart from "@/components/analytics/charts/WeeklyVisitorsRadarChart";
  ...
  return (
    <div className="h-full w-auto bg-[#EFEEF3] pb-12">
      ...
      <div className="mx-4 grid grid-cols-1 gap-4 pb-6 sm:grid-cols-2 md:mx-[2.5rem] lg:grid-cols-4">
        <StatCard 
          title="Total Users/audience"
          value="5,789K"
          changePercentage="46.9%"
          subtitle="This month"
        />
        <StatCard 
          title="Impressions"
        ...
        />
        <StatCard 
          title="Upcoming Ending Campaign"
          value="- 12 Days"
          changePercentage=""
          isWarning={true}
          warningText="Upgrade"
          expiryDate="Feb 15, 2024 - 12:45 PM"
        />
      </div>
      ...
      <div className="mt-6 px-4 md:px-6 lg:px-[2.5rem]">
